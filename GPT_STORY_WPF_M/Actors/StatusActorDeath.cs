...
namespace GPT_STORY_WPF_M.Actors
{
    public class StatusActorDeath
    {
        ...
        private string prompt4 = "Write a name if there is explicitly mentioned that someone has died in the text. Write only their name. Don't explain why, don't repeat the text to conclude. Just write the name if there is explicitly mentioned that someone has died in the text. If not, write \"nobody\".";
